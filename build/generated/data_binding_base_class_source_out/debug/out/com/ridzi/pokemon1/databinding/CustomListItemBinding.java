...
public final class CustomListItemBinding implements ViewBinding {
  ...
  private CustomListItemBinding(@NonNull LinearLayout rootView, @NonNull TextView name,
  ...
  public static CustomListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomListItemBinding((LinearLayout) rootView, name, pokemonImage, url);
    }
